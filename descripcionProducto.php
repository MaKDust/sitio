			              			...
			              			<div class="product-seller-recommended">
			                			...
			                			<div class="product-comments">
			                  				...
			                  				<form action="" class="form-inline md-5">
			                    				<textarea name="" id="" cols="50" rows="2" class="form-control mr-4" placeholder="Escribe tu pregunta"></textarea>
			                    				<button class="btn btn-lg btn-primary">Consulta!</button>
			                  				</form>
